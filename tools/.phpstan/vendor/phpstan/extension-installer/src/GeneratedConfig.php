...
final class GeneratedConfig
{
  ...
  array (
    'install_path' => '/usr/local/src/git-state/tools/.phpstan/vendor/ergebnis/phpstan-rules',
  ...
  array (
    'install_path' => '/usr/local/src/git-state/tools/.phpstan/vendor/phpstan/phpstan-strict-rules',
  ...
  array (
    'install_path' => '/usr/local/src/git-state/tools/.phpstan/vendor/tomasvotruba/type-coverage',
